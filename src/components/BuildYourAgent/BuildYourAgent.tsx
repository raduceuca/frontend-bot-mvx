        ...
        >
          ...
          <div className='flex flex-col gap-6'>
            <div className='flex flex-col gap-1'>
              ...
              <p className='text-base text-zinc-400 leading-relaxed max-w-2xl'>
                The entire stack is open source. Four steps to go from zero to a
                live agent on MultiversX.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
              {resources.map((res) => (
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className='flex items-center gap-3 px-4 py-3 rounded-lg border border-zinc-800/50 hover:border-zinc-700 hover:bg-zinc-900/40 transition-colors duration-150 group'
                >
