const styles = {
  ...
  statusDot: 'w-1.5 h-1.5 bg-teal rounded-full animate-pulse',
  statusText:
...
export const DashboardHeader = () => (
  <div className={styles.container}>
    <div className={styles.statusLine}>
      ...
      <span className={styles.statusText}>Max is online</span>
    </div>
    <h1 className={styles.title}>What should Max do?</h1>
  </div>
);
