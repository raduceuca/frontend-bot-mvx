...
export default {
  ...
  dashboardContent: 'dashboard-content flex flex-col gap-2 justify-center items-center flex-1 w-full overflow-auto border-l border-secondary pt-0 pb-4 lg:pt-0 lg:pb-6 transition-all duration-200 ease-out',
  dashboardContentMobilePanelOpen: 'dashboard-content-mobile-panel-open opacity-20 lg:opacity-100 pointer-events-none',
  dashboardWidgets: 'dashboard-widgets flex flex-col gap-6 w-full max-w-[1600px] px-4 md:px-10 flex-1'
