...
export const HomeCapabilities = () => {
  ...
  return (
    <div className='flex flex-col gap-6 xs:gap-8 w-full relative pt-8 xs:pt-10 sm:pt-16'>
      ...
      <div className='flex flex-col gap-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-3'>
          {capabilities.map((cap) => (
            <div
              key={cap.title}
              className='bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 rounded-xl p-4 xs:p-6 flex flex-col gap-2.5 xs:gap-3 hover:border-zinc-700 hover:-translate-y-0.5 transition-all duration-200'
            >
      ...
      <div className='relative rounded-2xl overflow-hidden'>
        ...
        <div className='relative z-10 flex flex-col gap-4 xs:gap-5 p-4 xs:p-6 sm:p-8 pt-24 xs:pt-32 sm:pt-40'>
          {/* Badge */}
          ...
          <div className='flex flex-col gap-2 max-w-lg'>
            ...
            <p className='text-base text-zinc-300 leading-relaxed'>
              Send 1 xEGLD. Max scans xExchange, picks tokens he likes, and
              sends them straight to your wallet. Every box is different — what
              will Max find?
            </p>
          </div>

          {/* Flow steps */}
          <div className='flex items-center flex-wrap gap-x-2 xs:gap-x-3 gap-y-1.5 text-sm xs:text-base'>
          ...
          <div className='flex items-center gap-3 pt-1'>
            ...
            >
              {isLoggedIn ? (
                <>
                  <img src={maxAvatar} alt='' className='w-5 h-5 rounded-sm' />
